                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="<?php echo e(route('register')); ?>">
                        ...
                        <div class="form-group<?php echo e($errors->has('fname') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input placeholder="Enter First Name" id="fname" type="text" class="form-control" name="fname" value="<?php echo e(old('fname')); ?>" required autofocus>
                        ...
                        <div class="form-group<?php echo e($errors->has('lname') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input placeholder="Enter Last Name"  id="lname" type="text" class="form-control" name="lname" value="<?php echo e(old('lname')); ?>" required autofocus>
                        ...
                        <div class="form-group<?php echo e($errors->has('email') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input  placeholder="Enter E-Mail Address" id="email" type="email" class="form-control" name="email" value="<?php echo e(old('email')); ?>" required>
