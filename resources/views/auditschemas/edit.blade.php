...
<h1><p align="center">Edit Audit Details</p> </h1>
     <form method="post" action="{{route('auditschema.update',[$Auditschema->id])}}">
     
                           {{csrf_field()}}
                           <input type="hidden" name="_method" value="put">
                           <input type="hidden" name="id" value="{{$Auditschema->id}}">
                           ...
                           <div class="form-group">
                                ...
                                <input placeholder="Eg.Baylor IT Audit end 31 Dec 2019"
                                       ...
                                       spellcheck="false"
                                       class="form-control"
                                       value="{{$Auditschema->AssignmentName}}"
                                       />
                            </div> 
                            ...
                            <div class="form-group">
                                ...
                                <input placeholder="Name"
                                       ...
                                       spellcheck="false"
                                       class="form-control"
                                       value="{{$Auditschema->AssignmentSupervisor}}"
                                       />
                            </div> 
                            ...
                            <div class="form-group">
                                ...
                                <input placeholder="name"
                                       ...
                                       spellcheck="false"
                                       class="form-control"
                                       value="{{$Auditschema->StaffAssigned}}"
                                       />
                            </div> 
                            ...
                            <div class="form-group">
                                ...
                                <input placeholder="Date"
                                       ...
                                       spellcheck="false"
                                       class="form-control"
                                       value="{{$Auditschema->PlanningMeeting}}"
                                       />
                            </div> 
                            ...
                            <div class="form-group">
                                ...
                                <input placeholder="Date"
                                       ...
                                       spellcheck="false"
                                       class="form-control"
                                       value="{{$Auditschema->KickoffMeeting}}"
                                       />
                            </div> 
                            ...
                            <div class="form-group">
                                ...
                                <input placeholder="Date"
                                       ...
                                       spellcheck="false"
                                       class="form-control"
                                       value="{{$Auditschema->EntryMeeting}}"
                                       />
                            </div> 
                            ...
                            <div class="form-group">
                                ...
                                <input placeholder="Date"
                                       ...
                                       spellcheck="false"
                                       class="form-control"
                                       value="{{$Auditschema->AuditExecution}}"
                                       />
                            </div> 
